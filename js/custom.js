document.addEventListener('DOMContentLoaded', function () {
    ...
    applyFilters();
            ...
            if ((activeFilters.minPrice || activeFilters.maxPrice) && priceEl) {
            ...
            if (activeFilters.bedrooms && bedroomsEl) {
                const bedroomsText = bedroomsEl.textContent;
                if (activeFilters.bedrooms.includes('+')) {
                    if (parseInt(bedroomsText) < parseInt(activeFilters.bedrooms.replace('+', ''))) {
                        show = false;
                    }
                } else {
                    if (parseInt(bedroomsText) !== parseInt(activeFilters.bedrooms)) {
                        show = false;
                    }
                }
            }
